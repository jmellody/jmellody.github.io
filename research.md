...
## [2] Cheap Talk: Coordinating and Fracturing Collective Action through Language
...
## [3] Remote Consensus is an Oxymoron: Lessons Learned from Pandemic-Era Scientists’ Deliberation Practices (with Janet Vertesi)

## [4] Keeping Time: Interaction Scripts as Coordinating Mechanisms for Self-Organizing Teams (with Vanessa Conzon) 

## [5] Narrating Value: How Staff Professionals Form Embedded Relationships with Line Workers
...
## [6] [Paper on Temporal Disorientation During the COVID-19 Pandemic] (with Ezra Zuckerman Sivan and Catresa Barlow)
